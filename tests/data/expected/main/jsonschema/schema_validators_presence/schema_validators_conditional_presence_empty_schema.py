...
#   filename:  schema_validators_conditional_presence_empty_schema.json
...
class ConditionalPresenceEmptySchema(_JsonSchemaRuntimeValidationBase):
    __json_schema_conditional_required__: ClassVar[tuple[Any, ...]] = (
        {
            'condition': ((('until',), ()),),
            'then_required_groups': ((('reviewBy',),),),
